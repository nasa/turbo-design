...
rotor1 = BladeRow(row_type=RowType.Rotor, location=location1)
stator1 = BladeRow(row_type=RowType.Stator,location=location2)
rotor2 = BladeRow(row_type=RowType.Rotor, location=location3)
stator2 = BladeRow(row_type=RowType.Stator,location=location4)
