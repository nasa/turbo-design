...
import sys
sys.path.insert(0,'../../')
from td3 import LossType, Units, TurbineSpool, Inlet, RowType, BladeRow
from td3.coolant import Coolant
from td3.loss.turbine import FixedEfficiency
import numpy as np 
...
station2.loss_model = FixedEfficiency(1)
station3.loss_model = FixedEfficiency(0.90)
