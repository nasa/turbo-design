...
# rotor30.coolant = Coolant(fluid, T0=T0*0.555556,P0=5E5,massflow_percentage=0)
# rotor50.coolant = Coolant(fluid, T0=T0*0.555556,P0=5E5,massflow_percentage=0)
...
# rotor30.beta2_metal = [-5,-5,-5] # Angle, hub,mean,tip
# rotor30.loss_model = FixedPressureLoss(0.05)

# rotor50.beta2_metal = [-20,-20,-20] # Angle, hub,mean,tip
# rotor50.loss_model = FixedPressureLoss(0.10)
